...
data class Earning(
        @field:SerializedName("call") val call: Call,
        @field:SerializedName("eps") val eps: Eps,
        @field:SerializedName("instrument") val instrument: String,
        @field:SerializedName("quarter") val quarter: Int,
        @field:SerializedName("report") val report: Report,
